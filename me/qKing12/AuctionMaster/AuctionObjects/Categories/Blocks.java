...
import static me.qKing12.AuctionMaster.Main.blocksCfg;
...
public class Blocks implements Category{
    ...
    public Blocks(){
        ...
        backgroundGlass=Main.itemConstructor.getItemFromMaterial("160:"+Main.plugin.getConfig().getString("blocks-menu-color"));
        ItemMeta meta = backgroundGlass.getItemMeta();
        meta.setDisplayName(" ");
        backgroundGlass.setItemMeta(meta);

        displayCategoryItem=Main.itemConstructor.getItemFromMaterial(blocksCfg.getString("blocks-menu-item"));
        ...
        slot=Main.menusCfg.getInt("browsing-menu.blocks-slot");
        slot--;
        slot*=9;
    }
