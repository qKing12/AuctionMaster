...
import static me.qKing12.AuctionMaster.Main.armorCfg;
...
public class Armor implements Category{
    ...
    public Armor(){
        ...
        backgroundGlass=Main.itemConstructor.getItemFromMaterial("160:"+Main.plugin.getConfig().getString("armor-menu-color"));
        ItemMeta meta = backgroundGlass.getItemMeta();
        meta.setDisplayName(" ");
        backgroundGlass.setItemMeta(meta);

        displayCategoryItem=Main.itemConstructor.getItemFromMaterial(armorCfg.getString("armor-menu-item"));
        ...
        slot=Main.menusCfg.getInt("browsing-menu.armor-slot");
        slot--;
        slot*=9;
    }
