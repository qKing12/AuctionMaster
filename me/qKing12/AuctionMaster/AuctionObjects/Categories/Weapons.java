...
import static me.qKing12.AuctionMaster.Main.weaponsCfg;
...
public class Weapons implements Category{
    ...
    public Weapons(){
        ...
        backgroundGlass=Main.itemConstructor.getItemFromMaterial("160:"+Main.plugin.getConfig().getString("weapons-menu-color"));
        ItemMeta meta = backgroundGlass.getItemMeta();
        meta.setDisplayName(" ");
        backgroundGlass.setItemMeta(meta);

        displayCategoryItem=Main.itemConstructor.getItemFromMaterial(weaponsCfg.getString("weapons-menu-item"));
        ...
        slot=Main.menusCfg.getInt("browsing-menu.weapons-slot");
        slot--;
        slot*=9;
    }
