package me.qKing12.AuctionMaster.InputGUIs.AnvilGUIHelper;
 ...
 * @since 1.0
 */
public interface AnvilGUIHelper {
     ...
     */
    void sendPacketOpenWindow(Player player, int containerId, String guiTitle);
     ...
     */
    Object newContainerAnvil(Player player, String guiTitle);
